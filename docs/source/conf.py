...
project = "CDK_pywrapper"
copyright = f"{date.today().year}, Olivier J. M. Béquignon"
...
parsed_version = re.match(
    r"(?P<major>\d+)\.(?P<minor>\d+)\.(?P<patch>\d+)(?:-(?P<release>[0-9A-Za-z-]+"
...
modindex_common_prefix = ["CDK_pywrapper."]
...
htmlhelp_basename = "CDK_pywrapper_doc"
